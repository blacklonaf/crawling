...
def main(section_code = '105'):
    ...
    records = parse_headlines(html)

    # __file__ : 해당 파일의 위치 (C:\Users\hwaro_0\Desktop\crolling\1weeks\day03\main.py)
    BASE_DIR = Path(__file__).parent # 현재 파일의 부모 파일의 path 개체 (C:\Users\hwaro_0\Desktop\crolling\1weeks\day03)
